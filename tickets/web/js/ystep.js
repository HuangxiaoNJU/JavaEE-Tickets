  ...
  $.fn.extend({
    ...
    loadStep: function(params){
      ...
      var baseHtml =  "<div class='ystep-container'>"+
                      ...
                      "</div>";
      //步骤框架
      var stepHtml = "<li class='ystep-step ystep-step-undone' data-container='body' data-toggle='popover' data-placement='bottom' data-title='' data-content='' data-trigger='hover'>"+
                     "</li>";
      //决策器
      var logic = {
        size: {
          large: function($html){
            ...
            containerWidth = (stepCount*330+330)+"px",
            progressWidth = (stepCount*330)+"px";
            $html.css({
