...
# Database: tickets
# Generation Time: 2018-03-22 14:30:58 +0000
# ************************************************************
...
INSERT INTO `project` (`id`, `name`, `begin_time`, `end_time`, `type`, `description`, `venue_id`)
VALUES
	(11,'开学典礼','2018-03-03 13:55:36','2018-03-04 13:55:36','讲座','南京大学信任校长吕建发表新学期开学演讲，请所有同学务必参加。南京大学信任校长吕建发表新学期开学演讲，请所有同学务必参加。南京大学信任校长吕建发表新学期开学演讲，请所有同学务必参加。南京大学信任校长吕建发表新学期开学演讲，请所有同学务必参加。',1),
	(12,'云计算、大数据和人工智能','2018-04-01 10:00:00','2018-04-02 17:30:00','讲座','人工智能、大数据已成为当下各行业最热门的话题。云计算，大数据，和人工智能，最近火的不行不行的词汇，似乎不相同，但又似乎相互关联，到底是什么样的关系呢？其实他们本没有什么关系，各自活在不同的世界里，然而随着互联网的发展，相互纠葛在了一起。',1),
	(15,'第八届Dota2国际邀请赛','2018-08-01 00:00:00','2018-08-10 00:00:00','电子竞技','DOTA2国际邀请赛，The International DOTA2 Championships。简称Ti，创立于2011年，是一个全球性的电子竞技赛事，每年一届，由ValveCorporation（V社）主办,奖杯为V社特制冠军盾牌，每一届冠军队伍及人员将记录在游戏泉水的冠军盾中。',2),
	(16,'J2EE讲座','2018-03-23 00:00:00','2018-03-24 00:00:00','讲座','J2EE',3);
